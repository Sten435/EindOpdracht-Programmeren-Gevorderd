...
namespace CUI {
	public abstract class Utility {
		...
		public static class Logger {
			public static void Error(Exception error, bool newLine = true, bool metKleur = true, bool clearConsole = false) {
			...
			public static void Error(string message, bool newLine = true, bool metKleur = true, bool clearConsole = false) {
				if (newLine)
					Error(new Exception(message), true, metKleur, clearConsole: clearConsole);
				else
					Error(new Exception(message), false, metKleur, clearConsole: clearConsole);
			}
