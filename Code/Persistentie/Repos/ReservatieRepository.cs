...
namespace Persistentie {
	...
	public class ReservatieRepository : IReservatieRepository {
		...
		public HashSet<Reservatie> GeefAlleReservaties(bool vandaagPlusToekomst = false, bool alleenVandaag = false, int klantenNummer = -1) => ReservatieMapper.GeefAlleReservaties(vandaagPlusToekomst, alleenVandaag, klantenNummer);

		public List<DateTime> GeefReservatiesPerToestel(string naam, DateTime? dag = null) => ReservatieMapper.GeefReservatiesPerToestel(naam, dag);
